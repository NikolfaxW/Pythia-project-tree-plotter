...
//    DrawHistogramFromTreeD0PT("../source/D0.root", "../results/D0", "T");
    ...
    bool repetitions = CheckLeafForRepetitions("../../Pythia-project-tree-creator/results/d0.root", "infT", "seed"),
            repetitionsJets = CheckLeafForRepetitions(
            "../../Pythia-project-tree-creator-inclusive-jets-/results/jets.root", "infT", "seed"),
            doDrawD0 = true,
            doDrawJets = true,
            doIntegralNorm = true,
            doWithoutCuts = true;
...
//        selection_array_angs[3] = "D_0_pT > 5 && jet_pT > 5";
        std::string variable_names_angs[1];
...
//        DrawHistogramFromTreeSetLeg("../../Pythia-project-tree-creator/results/d0.root", "../results/l11(no cuts)", "angT",
//                                    variable_array_angs, selection_array_angs, variable_names_angs, 1, false, true,
//                                    false, true, 0,
//                                    1,
...
//                                                  "Number of entries");
        ...
        if (doDrawD0 && repetitions) {
            ...
            if (doIntegralNorm)
                DrawHistogramFromTree("../../Pythia-project-tree-creator/results/d0.root",
                                      "../results/D0(integral norm)",
                                      "angT",
                                      variable_array, selection_array, variable_names, 2, false, true, true, true, 0,
                                      17,
                                      "p_{T,D^{0}}, p_{T,jet}, no cut", "p_{T}, GeV",
                                      "Number of entries");
            ...
            DrawHistogramFromTreeSetLeg("../../Pythia-project-tree-creator/results/d0.root", "../results/l11", "angT",
                                        ...
                                        "Number of entries", 0.54, 0.57, 0.84, 0.87);
            if (doIntegralNorm)
                DrawHistogramFromTreeSetLeg("../../Pythia-project-tree-creator/results/d0.root",
                                            "../results/l11(integral norm)", "angT",
                                            variable_array_angs, selection_array_angs, variable_names_angs, 4, false,
                                            true,
                                            true, true, 0,
                                            1,
                                            "#lambda^{1}_{1}", "#lambda^{1}_{1}",
        ...
        if (doDrawJets && repetitionsJets) {
            ...
            if (doIntegralNorm)
                DrawHistogramFromTree("../../Pythia-project-tree-creator-inclusive-jets-/results/jets.root",
                                      "../results/lead0(integral norm)",
                                      "angT",
                                      variable_array, selection_array, variable_names, 2, false, true, true, false, 0,
                                      15,
                                      "p_{T,lead}, p_{T,jet}, no cut", "p_{T}, GeV",
                                      "Number of entries");
            ...
            DrawHistogramFromTreeSetLeg("../../Pythia-project-tree-creator-inclusive-jets-/results/jets.root",
                                        "../results/jetsl11", "angT",
                                        variable_array_angs, selection_array_angs, variable_names_angs, 4, false, true,
                                        false, false, 0,
                                        1,
                                        "#lambda^{1}_{1}", "#lambda^{1}_{1}",
            ...
            if (doIntegralNorm)
                DrawHistogramFromTreeSetLeg("../../Pythia-project-tree-creator-inclusive-jets-/results/jets.root",
                                            "../results/jetsl11(integral norm)", "angT",
                                            variable_array_angs, selection_array_angs, variable_names_angs, 4, false,
                                            true,
                                            true, false, 0,
                                            1,
